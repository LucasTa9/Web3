...
-- activity
INSERT INTO permission (id, description) values (4, 'ROLE_REGISTER_PET');
INSERT INTO permission (id, description) values (5, 'ROLE_REMOVE_PET');
INSERT INTO permission (id, description) values (6, 'ROLE_SEARCH_PET');
